...
void Stampa_Classifica(heap_element *classifica, u_int64_t n_elementi_da_stampare);
...
inline static void copia_heap_element(heap_element* from, heap_element* to){
    to->id = from->id;
    to->peso = from->peso;
    to->txt = from->txt;
